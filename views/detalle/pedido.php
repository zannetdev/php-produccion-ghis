...
<?php
$modelo = $this->detalle->modelo;
$detalle_pedido = $this->detalle->detalle_pedido;
$json = json_decode($detalle_pedido->json_tallas);
?>
<input type="hidden" id="pwd" value="<?php echo '11'.date('dmy').'9';?>">
<input type="hidden" id="proceso_id" value="<?php echo $this->detalle->id_proceso ?>">
<input type="hidden" id="detalle_id" value="<?php echo $this->detalle->id_detalle ?>">
    ...
    <div id="tabs">
        ...
        <div class="row" id="tab_detalle">
            <div class="col-lg-3 mt-2">
                <div class="card">
                    <img class="card-img-top" src="<?php echo $this->detalle->modelo->imagen; ?>" alt="">
                    <div class="card-body">
                        <h4 class="card-title">Modelo</h4>
                        <p class="card-text">#<?php echo strtoupper($this->detalle->modelo->cod_diseño); ?></p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row container_pass">
                            <div class="form-group">
                              ...
                              <input type="text"
                                class="form-control" name="" id="pwd_bloqueo"  placeholder="***********">
