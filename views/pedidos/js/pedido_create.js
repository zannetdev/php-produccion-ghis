                ...
                if (doc_verification == true || sum == 7) {
                    ...
                    if (data.metodo_pago != undefined) {
                        ...
                        if (verification_payment == true) {
                            Swal.fire({
                                title: 'Mensaje',
                                html: 'Necesitamos confimación para crear el pedido, verifica que todos los datos estén correctos, una vez hecho el pedido, no se podrá editar.<br><small>*Verifica que esté bien el dinero.</small><h2>¿Deseas confirmar la operación?</h2>',
                                icon: 'question',
                            ...
                            if (data.metodo_pago == '1') {
                                ...
                                if(data.metodo_pago == '5'){
                                    ...
                                    Toast.fire({
                                        title: 'Error',
                                        html: 'Los créditos tienen que ser menores al total',
                                        icon: 'error'
                                    })
                                }else{
                                    SoundNotifier.Error();
                                    Toast.fire({
                                        title: 'Error',
                                        html: 'Ingresa el código de baucher',
                                        icon: 'error'
                                    })
                                }
                        ...
                        Toast.fire({
                            title: 'Error',
                            html: 'Selecciona un método de pago',
                            icon: 'error'
                        })
                    }
                } else {
