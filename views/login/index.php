...
>
  <head>
    ...
    <title>Ghisflex - Login</title>

    <meta name="description" content="Sistema de producción de la zapatería ghisflex" />
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="<?php echo URL;?>" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Ghisflex</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Producción Ghisflex 👋</h4>
              <p class="mb-4">Favor de ingresar tus datos para ingresar y comenzar una nueva aventura! 💯</p>
